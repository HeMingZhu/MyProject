...
public class WXPayUtil {
    ...
    public static String generateSignature(final Map<String, String> data, String key, WXPayConstants.SignType signType) throws Exception {
        ...
        if (WXPayConstants.SignType.MD5.equals(signType)) {
            // logger.info(sb.toString()+"====>"+MD5(sb.toString()).toUpperCase());
            System.out.print(sb.toString() + "====>" + MD5(sb.toString()).toUpperCase());
    ...
    public static synchronized String getCustNo() {
        ...
        String yy = CD.get(Calendar.YEAR) < 10 ? "0" + CD.get(Calendar.YEAR) : CD.get(Calendar.YEAR) + "";
        String mm = (CD.get(Calendar.MONTH) + 1) < 10 ? "0" + (CD.get(Calendar.MONTH) + 1) : (CD.get(Calendar.MONTH) + 1) + "";
        String dd = CD.get(Calendar.DATE) < 10 ? "0" + CD.get(Calendar.DATE) : CD.get(Calendar.DATE) + "";
        String hh = CD.get(Calendar.HOUR_OF_DAY) + "";
        String nn = CD.get(Calendar.MINUTE) + "";
        String ss = CD.get(Calendar.SECOND) + "";
        String mi = CD.get(Calendar.MILLISECOND) + "";
        String str = yy.substring(2) + mm + dd + hh + nn + ss + mi;
        try {
            Thread.sleep(100);
